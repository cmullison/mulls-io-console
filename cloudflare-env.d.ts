/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: a7c3fdf2dee5b569b6af72cd9464a4f4)
// Runtime types generated with workerd@1.20250730.0 2025-08-02 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		NEXT_INC_CACHE_KV: KVNamespace;
		EMAIL_FROM: "no-reply@notifications.mulls.io";
		EMAIL_FROM_NAME: "Mulls.io";
		EMAIL_REPLY_TO: "support@mulls.io";
		NEXTJS_ENV: string;
