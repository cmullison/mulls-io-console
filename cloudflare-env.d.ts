/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: 10d598c864a2a9b5a6881d5889b1eac6)
// Runtime types generated with workerd@1.20250730.0 2025-08-02 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		NEXT_INC_CACHE_KV: KVNamespace;
		EMAIL_FROM: "no-reply@updates.mulls.io";
		EMAIL_FROM_NAME: "Mulls.io";
		EMAIL_REPLY_TO: "support@updates.mulls.io";
		R2_DEFAULT_BUCKET: "documents";
		CLOUDFLARE_ACCOUNT_ID: "1e9408c2be90eae9689a2b6942ca5d87";
		NEXTJS_ENV: string;
		NEXT_CACHE_DO_QUEUE: DurableObjectNamespace /* DOQueueHandler */;
		sequential: DurableObjectNamespace<import("./agents-worker").Sequential>;
		routing: DurableObjectNamespace<import("./agents-worker").Routing>;
		parallel: DurableObjectNamespace<import("./agents-worker").Parallel>;
		orchestrator: DurableObjectNamespace<import("./agents-worker").Orchestrator>;
		evaluator: DurableObjectNamespace<import("./agents-worker").Evaluator>;
		sequentialBuilder: DurableObjectNamespace<import("./agents-worker").SequentialBuilder>;
		parallelSections: DurableObjectNamespace<import("./agents-worker").ParallelSections>;
		orchestratorCreator: DurableObjectNamespace<import("./agents-worker").OrchestratorCreator>;
		evaluatorOptimizer: DurableObjectNamespace<import("./agents-worker").EvaluatorOptimizer>;
		prdGenerator: DurableObjectNamespace /* PRDGenerator */;
		heroAgent: DurableObjectNamespace /* HeroAgent */;
		navigationAgent: DurableObjectNamespace /* NavigationAgent */;
		featuresAgent: DurableObjectNamespace /* FeaturesAgent */;
		testimonialsAgent: DurableObjectNamespace /* TestimonialsAgent */;
		contactAgent: DurableObjectNamespace /* ContactAgent */;
		architectureReviewer: DurableObjectNamespace /* ArchitectureReviewer */;
		deliveryPackager: DurableObjectNamespace /* DeliveryPackager */;
		documents: R2Bucket;
		images: R2Bucket;
		videos: R2Bucket;
		chum: R2Bucket;
		...
		WORKER_SELF_REFERENCE: Service<typeof import("./agents-worker").default>;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "EMAIL_FROM" | "EMAIL_FROM_NAME" | "EMAIL_REPLY_TO" | "R2_DEFAULT_BUCKET" | "CLOUDFLARE_ACCOUNT_ID" | "NEXTJS_ENV">> {}
}
