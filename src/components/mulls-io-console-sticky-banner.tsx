...
const STORAGE_KEY = "mulls-io-console-banner-collapsed";

export function MullsIOConsoleStickyBanner() {
        ...
        <div className="relative flex items-center w-[90vw] md:max-w-[400px]">
          ...
          <div className="bg-gray-100 dark:bg-background rounded-lg shadow-xl border-2 relative">
            ...
            <div className="flex items-center flex-col py-3 px-3">
              <a
                href="https://mulls.io?ref=console-banner"
                target="_blank"
              ...
              >
                <div className="flex items-center">
                  ...
                  <PillBottle className="h-7 w-7 mx-1.5" />
                  <span className="whitespace-nowrap">Mulls.io</span>
                </div>
              ...
              <Button size="sm" className="mt-4" asChild>
                <a href="https://mulls.io?ref=console-banner" target="_blank">
