...
export const SITE_NAME = "Mulls.io Console"
export const SITE_DESCRIPTION = "Monitoring and configuration for Mulls.io"
export const SITE_URL = process.env.NODE_ENV === "development" ? "http://localhost:3000" : "https://console.mulls.io"
export const GITHUB_REPO_URL = "https://github.com/cmullison/mulls-io-console"
